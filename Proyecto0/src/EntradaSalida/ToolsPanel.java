...
public class ToolsPanel {
    //ventanas emergentes para entrada y salida de datos
    ...
    public static void imprimeSalida(boolean msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(byte msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(int msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(float msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(short msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(double msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(long msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    public static void imprimeSalida(char msje) {
        JOptionPane.showMessageDialog(null, msje, "Salida de datos", JOptionPane.QUESTION_MESSAGE);
    }
    ...
    public static String seguirSino() {
        return JOptionPane.showInputDialog(null, "deseas continuar", "capturando datos", JOptionPane.YES_NO_OPTION);
    }}
